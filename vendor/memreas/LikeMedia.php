...
if (!isset($media_id) || empty($media_id)) {
    ...
    $q = "select comment_id from `comment` where media_id ='$media_id' and `type` = 'like' and  user_id='$user_id'";
   // $result = mysql_query($q);
    ...
    if (!$row) {
        ...
        $q_event_media = "SELECT * FROM `event_media` where media_id='$media_id'";
        ...
        if (!$result_event_media) {
            ...
            $q_comment = "INSERT INTO `comment` (comment_id,`media_id`,
                                `user_id`,
                                `type`,
                                `event_id`,
                                `create_time`, 

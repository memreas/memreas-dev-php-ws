...
class ResumableDownload {
	 ...
	 * @param string $key
	 *        	Key of the object
	 * @param string|resource|EntityBodyInterface $target
	 *        	Where the object should be downloaded to. Pass a string to
	 ...
	 *        	EntityBody.
	 * @param array $params
	 *        	Any additional GetObject or HeadObject parameters to use
	...
	public function __invoke() {
		...
		$this->params ['SaveAs'] = new ReadLimitEntityBody ( $this->target, $this->meta ['ContentLength'], $this->target->ftell () );

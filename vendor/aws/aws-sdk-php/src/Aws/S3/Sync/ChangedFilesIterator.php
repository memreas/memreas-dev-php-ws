...
class ChangedFilesIterator extends \FilterIterator {
	 ...
	 * @param \Iterator $targetIterator
	 *        	Iterator used to compare against the source iterator
	 * @param FilenameConverterInterface $sourceConverter
	 *        	Key converter to convert source to target keys
	 * @param FilenameConverterInterface $targetConverter
	 ...
	 *        	
	 * @return array bool an array of data, or false if the key is not in the iterator
	 */

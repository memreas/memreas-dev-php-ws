...
class ClearBucket extends AbstractHasDispatcher {
	...
	/**
	 * Get the iterator used to yield the keys to be deleted.
	 * A default iterator
	...
	/**
	 * Sets a different iterator to use than the default iterator.
	 * This can be helpful when you wish to delete
	 ...
	 *
	 * @param string $mfa
	 *        	MFA token to send with each request. The value is the concatenation of the authentication

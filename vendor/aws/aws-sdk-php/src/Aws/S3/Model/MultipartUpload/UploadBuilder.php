...
class UploadBuilder extends AbstractUploadBuilder {
	...
	/**
	 * Set the concurrency level to use when uploading parts.
	 * This affects how
	 ...
	 * operation).
	 * This setting can ony be used with seekable data sources.
	 *
	 * @param bool $calculateMd5

...
class UploadPartGenerator implements \Serializable, \IteratorAggregate, \Countable {
	 ...
	 *        	The upload body
	 * @param int $partSize
	 *        	The size of parts to split the upload into
	 *        	
	 ...
	 *        	The upload body
	 * @param int $partSize
	 *        	The size of parts to split the upload into. Default is the 4GB max
	 *        	
	...
	/**
	 * Returns a single upload part from the calculated uploads by part number.
	 * By default it returns the first, which
	 * is useful behavior if there is only one upload.
	 *
	 * @param int $partNumber
	 *        	The numerical index of the upload
	 *        	
	 * @return UploadPart
	...
	public function unserialize($serialized) {
		...
		foreach ( array (
			...
			if (isset ( $data [$property] )) {
				...
				throw new RuntimeException ( sprintf ( 'Cannot unserialize the %s class. The %s property is missing.', __CLASS__, $property ) );
			}
		}
	}
	 ...
	 *        	The newly completed upload part
	 *        	

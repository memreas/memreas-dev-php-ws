...
class Route53Client extends AbstractClient {
	...
	/**
	 * Retrieves the server time from Route53.
	 * Can be useful for detecting and/or preventing clock skew.
	 *
	...
	/**
	 * Filter function used to remove ID prefixes.
	 * This is used automatically by the client so that Hosted Zone and
	 * Change Record IDs can be specified with or without the prefix.
	 *
	 * @param string $id
	 *        	The ID value to clean
	 *        	
	 * @return string
	 */

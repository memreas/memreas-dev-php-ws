...
class MessageValidator {
	...
	public function __construct(Client $client = null) {
		if (! extension_loaded ( 'openssl' )) {
			...
			throw new RequiredExtensionNotLoadedException ( 'The openssl extension is required to use the SNS Message ' . 'Validator. Please install this extension in order to use this feature.' );
	...
	/**
	 * Determines if a message is valid and that is was delivered by AWS.
	 * This method does not throw exceptions and

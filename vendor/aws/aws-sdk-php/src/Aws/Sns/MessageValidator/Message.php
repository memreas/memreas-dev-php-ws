...
class Message {
	...
	public static function fromArray(array $data) {
		...
		$requiredKeys = array_merge ( self::$requiredKeys ['__default'], isset ( self::$requiredKeys [$data ['Type']] ) ? self::$requiredKeys [$data ['Type']] : array () );
	 ...
	 *        	A Collection of message data with all required keys
	 */

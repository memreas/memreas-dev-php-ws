...
class DynamoDbClient extends AbstractClient {
	...
	public static function factory($config = array()) {
							...
							new TruncatedBackoffStrategy ( 11, 
									...
									new ThrottlingErrorChecker ( $exceptionParser, 
											...
											new HttpBackoffStrategy ( null, 
													...
													new CurlBackoffStrategy ( null, new ExpiredCredentialsChecker ( $exceptionParser, 
		...
		return ClientBuilder::factory ( __NAMESPACE__ )->setConfig ( $config )->setConfigDefaults ( array (
				...
				self::COMMAND_PARAMS => array (
						Cmd::RESPONSE_PROCESSING => Cmd::TYPE_NO_TRANSLATION 
				) 
	 ...
	 *
	 * @param mixed $value
	 *        	The value to format for DynamoDB.
	 * @param string $format
	 *        	The type of format (e.g. put, update).
	 *        	
	 ...
	 *
	 * @param array $values
	 *        	The values to format for DynamoDB.
	 * @param string $format
	 *        	The type of format (e.g. put, update).
	 *        	

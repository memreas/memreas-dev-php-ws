...
/**
 * Class representing a DynamoDB item attribute.
 * Contains helpers for building
...
class Attribute implements ToArrayInterface {
	...
	/**
	 *
	 * @var string array DynamoDB attribute value
	 */
	protected $value;
	 ...
	 * value.
	 * Some objects can be used as values as well. If the object has a
	 ...
	 * @param int $depth
	 *        	A variable used internally to keep track of recursion
	 ...
	 *        	The DynamoDB attribute value
	 * @param string $type
	 *        	The DynamoDB attribute type (N, S, B, NS, SS, BS)
	 */
	 ...
	 *
	 * @param string $format
	 *        	The format to apply to the data
	 *        	

...
/**
 * Represents a batch put request.
 * It is composed of a table name and item
 */
class PutRequest extends AbstractWriteRequest {
	 ...
	 *        	The command to create the request from
	 *        	
	 * @return PutRequest
	 *
	 ...
	 *
	 * @param Item $item
	 *        	The item to put into DynamoDB
	 * @param string $tableName
	 *        	The name of the table which has the item
	 *        	

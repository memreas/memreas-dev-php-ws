 ...
 * queue for sending DynamoDB DeleteItem and PutItem requests.
 * You can add
...
class WriteRequestBatch extends AbstractBatchDecorator {
	 ...
	 * @param int $batchSize
	 *        	Size of each batch. The WriteRequestBatch works most efficiently with a
	 *        	batch size that is a multiple of 25
	 * @param mixed $notify
	 *        	Callback to be run after each flush
	 *        	

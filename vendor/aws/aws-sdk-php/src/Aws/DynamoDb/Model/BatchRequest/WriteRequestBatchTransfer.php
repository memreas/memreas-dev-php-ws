...
class WriteRequestBatchTransfer implements BatchTransferInterface {
	 ...
	 * @param UnprocessedWriteRequestsException $unprocessedRequests
	...
	/**
	 * Handles unprocessed items from the executed commands.
	 * Unprocessed items
	...
	/**
	 * Handles exceptions caused by the request being too large (over 1 MB).
	 * The
	 ...
	 *
	 * @param array $items
	 *        	Data formatted under "RequestItems" or "UnprocessedItems" keys
	 *        	
	 * @return array
	 */

...
/**
 * Base class for session locking strategies.
 * Includes write and delete logic
 */
abstract class AbstractLockingStrategy implements LockingStrategyInterface {
	 ...
	 *        	The value of the key (i.e., the session ID)
	 *        	
	 * @return array formatted key structure
	 */
	protected function formatKey($keyValue) {
		$keyName = ($this->client->getApiVersion () < '2012-08-10') ? 'HashKeyElement' : $this->config->get ( 'hash_key' );

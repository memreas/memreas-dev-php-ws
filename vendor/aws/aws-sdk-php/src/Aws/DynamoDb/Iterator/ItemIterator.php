...
/**
 * Converts items to a simple associative array form with type information removed.
 * Also performs base64_decode on
...
class ItemIterator extends \IteratorIterator implements \Countable, ToArrayInterface {
	 ...
	 *        	The result of a DynamoDB operation that potentially contains items
	...
	public function current() {
		return new Collection ( array_map ( array (
				$this,
				'processAttribute' 
		), parent::current () ) );
	}
	 ...
	 * array structure of an item.
	 * The method also base64 decodes the value any Binary attributes
	 *

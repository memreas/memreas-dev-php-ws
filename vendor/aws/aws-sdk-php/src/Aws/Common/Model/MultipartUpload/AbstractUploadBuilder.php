...
abstract class AbstractUploadBuilder {
	 ...
	 * This is useful for resuming from a previously started multipart upload.
	 * You must use a local file stream as the data source if you wish to resume from a previous upload.
	 *
	 * @param TransferStateInterface|string $state
	 *        	Pass a TransferStateInterface object or the ID of the initiated
	 ...
	 *
	 * @param resource|string|EntityBody $source
	 *        	Source of the transfer. Pass a string to transfer from a file on disk.

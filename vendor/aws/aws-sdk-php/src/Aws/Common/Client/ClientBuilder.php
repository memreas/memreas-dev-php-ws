...
class ClientBuilder {
	 ...
	 *
	 * @param array|Collection $defaults
	 *        	The default values
	 *        	
	 * @return ClientBuilder
	 */
	...
	/**
	 * Sets the exception parser.
	 * If one is not provided the builder will use
	 ...
	 * set and falling back to default values.
							...
							new ThrottlingErrorChecker ( $this->exceptionParser, 
									...
									new HttpBackoffStrategy ( array (
											...
											new CurlBackoffStrategy ( null, 
													...
													new ExpiredCredentialsChecker ( $this->exceptionParser, new ExponentialBackoffStrategy () ) ) ) ) ) );
	...
	/**
	 * Ensures that an array (e.g.
	 * for config data) is actually in array form
	 *
	 ...
	 * The signature can be set to a valid signature

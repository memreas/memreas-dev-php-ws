...
class IntegrationTest extends \Aws\Tests\IntegrationTestCase {
	...
	/**
	 * The SES integration tests use the VERIFIED_EMAIL value set in your phpunit.functional.xml as the sender.
	 * This
	...
	public function testBasicIdentityCrudOperations() {
		...
		$this->ses->getCommand ( 'VerifyEmailIdentity', array (
				'EmailAddress' => $emailAddress 
		) )->execute ();
		$this->ses->waitUntilIdentityExists ( array (
				'Identities' => array (
						$emailAddress 
				) 
		) );
		...
		$this->ses->getCommand ( 'DeleteIdentity', array (

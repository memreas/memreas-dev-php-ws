...
class AcpBuilderTest extends \Guzzle\Tests\GuzzleTestCase {
	public function testCanSetOwner() {
		...
		$this->assertInstanceOf ( 'Aws\S3\Model\Grantee', $this->readAttribute ( $builder, 'owner' ) );
	}
	...
	public function testCanBuildAnAcp() {
		$acl = AcpBuilder::newInstance ()->setOwner ( '1234567890' )->addGrantForEmail ( Permission::READ, 'foo@example.com' )->build ();

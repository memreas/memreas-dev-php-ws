...
class PostObjectTest extends \Guzzle\Tests\GuzzleTestCase {
	...
	public function setUp() {
		$credentials = $this->getMockBuilder ( 'Aws\Common\Credentials\Credentials' )->disableOriginalConstructor ()->getMock ();
		$credentials->expects ( $this->any () )->method ( 'getAccessKeyId' )->will ( $this->returnValue ( 'AKIAXXXXXXXXXXXXXXX' ) );
		$credentials->expects ( $this->any () )->method ( 'getSecretKey' )->will ( $this->returnValue ( 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' ) );
	...
	public function getDataForPostObjectTest() {
		...
		$cases [] = array (
				// Options
				array (
						'policy' => '{"expiration":"1984-11-24T00:00:00Z","conditions":[{"bucket":"foo"},{"success_action_stat' . 'us":"201"},["starts-with","$key","foo\\/bar\\/"],["starts-with","$Content-Type","text\\/"]]}' 
				),
				// Expected Results
				array (
						'attributes' => array (
						...
						'inputs' => array (
								'AWSAccessKeyId' => 'AKIAXXXXXXXXXXXXXXX',
								'key' => '${filename}',
								'policy' => 'eyJleHBpcmF0aW9uIjoiMTk4NC0xMS0yNFQwMDowMDowMFoiLCJjb25kaXRpb25zIjpbeyJidWNrZXQiOiJmb' . '28ifSx7InN1Y2Nlc3NfYWN0aW9uX3N0YXR1cyI6IjIwMSJ9LFsic3RhcnRzLXdpdGgiLCIka2V5IiwiZm9vXC9iYXJc' . 'LyJdLFsic3RhcnRzLXdpdGgiLCIkQ29udGVudC1UeXBlIiwidGV4dFwvIl1dfQ==',

...
class CloudFrontClientTest extends \Guzzle\Tests\GuzzleTestCase {
	...
	public function testCreatesCannedSignedUrlsForRtmpWhileStrippingFileExtension() {
		...
		$this->assertEquals ( '{"Statement":[{"Resource":"test.mp4","Condition":{"DateLessThan":{"AWS:EpochTime":' . $ts . '}}}]}', $result );
		...
		$this->assertEquals ( '{"Statement":[{"Resource":"videos/test.mp4","Condition":{"DateLessThan":{"AWS:EpochTime":' . $ts . '}}}]}', $result );
	}

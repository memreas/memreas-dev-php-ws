...
class SignatureV2Test extends \Guzzle\Tests\GuzzleTestCase {
	...
	private function getSignature() {
		...
		$signature = $this->getMock ( 'Aws\Common\Signature\SignatureV2', array (
				'getTimestamp' 
		) );
	...
	public function testSignsRequestsWithSecurityToken() {
		...
		$this->assertEquals ( "POST\nfoo.com\n/\nAWSAccessKeyId=AKIDEXAMPLE&SecurityToken=foo&SignatureMethod=HmacSHA256&SignatureVersion=2&Test=123&Timestamp=2011-09-09T23%3A36%3A00%2B00%3A00", $request->getParams ()->get ( 'aws.string_to_sign' ) );
	}

...
DOCBLOCK;
	 ...
	 * accept only [AnnotationEnumLiteral::ONE, AnnotationEnumLiteral::TWO, AnnotationEnumLiteral::THREE], but got 4.
	 */
...
DOCBLOCK;
	...
	/**
	 * @expectedException \InvalidArgumentException
	 * @expectedExceptionMessage Invalid Target "Foo".
	 * Available targets: [ALL, CLASS, METHOD, PROPERTY, ANNOTATION]
	 */

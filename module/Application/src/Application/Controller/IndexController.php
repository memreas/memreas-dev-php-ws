    ...
    public function indexAction ()
    {
        ...
        Mlog::addone(
                __CLASS__ . __METHOD__ .
                         'before $this->requiresSecureAction ( $actionname )', 
                        $actionname);
        
        $data = simplexml_load_string($_POST['xml']);
        if (($actionname == 'addmediaevent') &&
                 ($data->addmediaevent->is_profile_pic)) {
            // do nothing - profile pic upload for registration
        } else 
            if ($this->requiresSecureAction($actionname)) {
                $actionname = $this->fetchSession($actionname, 
                        $this->requiresSecureAction($actionname));
            }
        Mlog::addone(
                __CLASS__ . __METHOD__ .
                         'after $this->requiresSecureAction ( $actionname )', 
                        $actionname);
        ...
        if (isset($actionname) && ! empty($actionname)) {
            ...
            if ($actionname == 'notlogin') {
                ...
                if ($actionname == "login") {
                    ...
                    $login = new Login($message_data, $memreas_tables, 
                            $this->getServiceLocator());
                    $result = $login->exec($this->sessHandler, 
                    ...
                    if ($actionname == "registration") {
                        $registration = new Registration($this->sessHandler, 
                                $message_data, $memreas_tables, 
                                $this->getServiceLocator());
                        ...
                        if ($actionname == "addcomments") {
                            $addcomment = new AddComment($message_data, 
                                    $memreas_tables, $this->getServiceLocator());
                            ...
                            if ($actionname == "verifyemailaddress") {
                                $verifyemailaddress = new VerifyEmailAddress(
                                        $message_data, $memreas_tables, 
                                        $this->getServiceLocator());
                                ...
                                if ($result) {
                                    if (! empty($_GET['perf'])) {
                                        ...
                                        $redirect = MemreasConstants::WEB_URL .
                                                 "index?email_verified=1";
                                        return $this->redirect()->toUrl(
                                                $redirect);
                                    }
                                } else {
                                    $redirect = MemreasConstants::WEB_URL .
                                             "index?email_verified=0";
                                ...
                                if ($actionname == "checkusername" ||
                                         $actionname == "chkuname") {
                                    $chkuname = new ChkUname($message_data, 
                                            $memreas_tables, 
                                            $this->getServiceLocator());
                                    ...
                                    if ($actionname == "fetchcopyrightbatch") {
                                        $fetchcopyrightbatch = new FetchCopyRightBatch(
                                                $message_data, $memreas_tables, 
                                                $this->getServiceLocator());
                                        $result = $fetchcopyrightbatch->exec();
                                    } else 
                                        if ($actionname == "generatemediaid") {
                                            $generatemediaid = new GenerateMediaId(
                                                    $message_data, 
                                                    $memreas_tables, 
                                                    $this->getServiceLocator());
                                            ...
                                            if ($actionname == "addmediaevent") {
                                                ...
                                                $addmediaevent = new AddMediaEvent(
                                                        $message_data, 
                                                        $memreas_tables, 
                                                        $this->getServiceLocator());
                                                ...
                                                if ($actionname == "likemedia") {
                                                    $data = simplexml_load_string(
                                                            $_POST['xml']);
                                                    $cache_id = trim(
                                                            $data->likemedia->user_id);
                                                    /*
                                                     * Cache approach - write
                                                     * operation - pass for now
                                                     */
                                                    
                                                    $result = $this->redis->getCache(
                                                            $actionname . '_' .
                                                                     $cache_id);
                                                    if (! $result ||
                                                             empty($result)) {
                                                    ...
                                                    if ($actionname ==
                                                        ...
                                                        $data = simplexml_load_string(
                                                                $_POST['xml']);
                                                        $mediainappropriate = new MediaInappropriate(
                                                                $message_data, 
                                                                $memreas_tables, 
                                                                $this->getServiceLocator());
                                                        ...
                                                        if ($actionname ==
                                                            ...
                                                            $data = simplexml_load_string(
                                                                    $_POST['xml']);
                                                            $cache_id = trim(
                                                                    $data->countlistallmedia->user_id);
                                                            $result = $this->redis->getCache(
                                                                    $actionname .
                                                                             '_' .
                                                                             $cache_id);
                                                            ...
                                                            if (! $result ||
                                                                     empty(
                                                                            $result)) {
                                                                $countlistallmedia = new CountListallmedia(
                                                                        $message_data, 
                                                                        $memreas_tables, 
                                                                        $this->getServiceLocator());
                                                                            ...
                                                                            if ($actionname ==
                                                                                ...
                                                                                if ($actionname ==
                                                                                    ...
                                                                                    if (! $result ||
                                                                                             empty(
                                                                                                    $result)) {
                                                                                        $viewallfriends = new ViewAllfriends(
                                                                                                $message_data, 
                                                                                                $memreas_tables, 
                                                                                                $this->getServiceLocator());
                                                                                    ...
                                                                                    if ($actionname ==
                                                                                        ...
                                                                                        if ($actionname ==
                                                                                            ...
                                                                                            $data = simplexml_load_string(
                                                                                                    $_POST['xml']);
                                                                                            if (! empty(
                                                                                                    $data->listallmedia->event_id)) {
                                                                                                $cache_id = $data->listallmedia->event_id;
                                                                                            } else 
                                                                                                if (! empty(
                                                                                                        $data->listallmedia->user_id)) {
                                                                                            ...
                                                                                            if ($actionname ==
                                                                                                ...
                                                                                                $data = simplexml_load_string(
                                                                                                        $_POST['xml']);
                                                                                                if (! empty(
                                                                                                        $data->countviewevent->is_public_event) &&
                                                                                                         $data->countviewevent->is_public_event) {
                                                                                                    $cache_id = "public";
                                                                                                } else {
                                                                                                    $cache_id = trim(
                                                                                                            $data->countviewevent->user_id);
                                                                                                }
                                                                                                $result = $this->redis->getCache(
                                                                                                        $actionname .
                                                                                                                 '_' .
                                                                                                ...
                                                                                                if (! $result ||
                                                                                                         empty(
                                                                                                                $result)) {
                                                                                                    $countviewevent = new CountViewevent(
                                                                                                            $message_data, 
                                                                                                            $memreas_tables, 
                                                                                                            $this->getServiceLocator());
                                                                                                    ...
                                                                                                    if ($actionname ==
                                                                                                        ...
                                                                                                        if ($actionname ==
                                                                                                            ...
                                                                                                            $data = simplexml_load_string(
                                                                                                                    $_POST['xml']);
                                                                                                            if (! empty(
                                                                                                                    $data->viewevent->is_public_event) &&
                                                                                                                     $data->viewevent->is_public_event) {
                                                                                                                $cache_id = "public";
                                                                                                            } else 
                                                                                                                if (! empty(
                                                                                                                        $data->viewevent->is_friend_event) &&
                                                                                                                         $data->viewevent->is_friend_event) {
                                                                                                                    $cache_id = "is_friend_event_" .
                                                                                                                     trim(
                                                                                                                            $data->viewevent->user_id);
                                                                                                        } else 
                                                                                                            if (! empty(
                                                                                                                    $data->viewevent->is_my_event) &&
                                                                                                                     $data->viewevent->is_my_event) {
                                                                                                                $cache_id = "is_my_event_" .
                                                                                                                 trim(
                                                                                                                        $data->viewevent->user_id);
                                                                                                    }
                                                                                            $result = $this->redis->getCache(
                                                                                            ...
                                                                                            if ($actionname ==
                                                                                                ...
                                                                                                $data = simplexml_load_string(
                                                                                                        $_POST['xml']);
                                                                                                $uid = trim(
                                                                                                        $data->addfriend->user_id);
                                                                                                $fid = trim(
                                                                                                        $data->addfriend->friend_id);
                                                                                                // error_log
                                                                                                // (
                                                                                                // 'file--->'
                                                                                                // .
                                                                                                ...
                                                                                                if ($actionname ==
                                                                                                         "addfriendtoevent") {
                                                                                                    $addfriendtoevent = new AddFriendtoevent(
                                                                                                            $message_data, 
                                                                                                            $memreas_tables, 
                                                                                                            $this->getServiceLocator());
                                                                                                    ...
                                                                                                    if ($actionname ==
                                                                                                        ...
                                                                                                        $data = simplexml_load_string(
                                                                                                                $_POST['xml']);
                                                                                                        if (! empty(
                                                                                                                $data->viewmediadetails->event_id) &&
                                                                                                                 ! empty(
                                                                                                                        $data->viewmediadetails->media_id)) {
                                                                                                            $cache_id = trim(
                                                                                                                    $data->viewmediadetails->event_id) .
                                                                                                             "_" .
                                                                                                             trim(
                                                                                                ...
                                                                                                if (! $result ||
                                                                                                         empty(
                                                                                                                $result)) {
                                                                                                    $viewmediadetails = new ViewMediadetails(
                                                                                                            $message_data, 
                                                                                                            $memreas_tables, 
                                                                                                            $this->getServiceLocator());
                                                                                                ...
                                                                                                if ($actionname ==
                                                                                                         "snsProcessMediaPublish") {
                                                                                                    $snsProcessMediaPublish = new snsProcessMediaPublish(
                                                                                                            $message_data, 
                                                                                                            $memreas_tables, 
                                                                                                            $this->getServiceLocator());
                                                                                                    ...
                                                                                                    if ($actionname ==
                                                                                                        ...
                                                                                                        if ($actionname ==
                                                                                                                 "uploadadvertisement") {
                                                                                                            $uploadadvertisement = new UploadAdvertisement(
                                                                                                                    $message_data, 
                                                                                                                    $memreas_tables, 
                                                                                                                    $this->getServiceLocator());
                                                                                                                ...
                                                                                                                if ($actionname ==
                                                                                                                    ...
                                                                                                                    if ($actionname ==
                                                                                                                        ...
                                                                                                                        if ($actionname ==
                                                                                                                            ...
                                                                                                                            //
                                                                                                                            $data = ! empty(
                                                                                                                                    $_POST['xml']) ? simplexml_load_string(
                                                                                                                                    $_POST['xml']) : null;
                                                                                                                            $user_id = $data->listnotification->user_id;
                                                                                                                            $cache_id = ! empty(
                                                                                                                                    $data) ? trim(
                                                                                                                                    $data->listnotification->user_id) : null;
                                                                                                                            try {
                                                                                                                                $result = ! empty(
                                                                                                                                        $cache_id) ? $this->redis->getCache(
                                                                                                                                        $actionname .
                                                                                                                                                 '_' .
                                                                                                                                                 $cache_id) : false;
                                                                                                                            } catch (\Exception $e) {
                                                                                                                            ...
                                                                                                                            if (! $result ||
                                                                                                                                     empty(
                                                                                                                                            $result)) {
                                                                                                                                $listnotification = new ListNotification(
                                                                                                                                        $message_data, 
                                                                                                                                        $memreas_tables, 
                                                                                                                                        $this->getServiceLocator());
						...
						$user_ids = array();
                                                                                                                                            ...
                                                                                                                                            if (MemreasConstants::REDIS_SERVER_USE) {
                                                                                                                                                ...
                                                                                                                                                $usernames = array_values(
                                                                                                                                                        $usernames);
                                                                                                                                                $person_meta_hash = $this->redis->cache->hmget(
                                                                                                                                                        "@person_meta_hash", 
                                                                                                                                                        $usernames);
                                                                                                                                                ...
                                                                                                                                                // response...
                                                                                                                                                $user_ids = array();
                                                                                                                                                $search_array_values = array_values(
                                                                                                                                                        $person_meta_hash);
                                                                                                                                                $search_result = array();
                                                                                                                                                foreach ($search_array_values as $entry) {
                                                                                                                                                    $entry_arr = json_decode(
                                                                                                                                                            $entry, 
                                                                                                                                                            true);
                                                                                                                                    ...
                                                                                                                                    $qb->select(
                                                                                                                                            'f.friend_id,uf.user_approve');
                                                                                                                                    $qb->from(
                                                                                                                                            'Application\Entity\Friend', 
                                                                                                                                            'f');
                                                                                                                                    $qb->join(
                                                                                                                                            'Application\Entity\UserFriend', 
                                                                                                                                            'uf', 
                                                                                                                                            'WITH', 
                                                                                                                                            'uf.friend_id = f.friend_id');
                                                                                                                                    $qb->where(
                                                                                                                                            "f.network='memreas'");
                                                                                                                                    $qb->andwhere(
                                                                                                                                            "uf.user_approve = '1'");
						...
						$mc = $this->redis->getCache('!event');
                                                                                                                                    $eventRep = $this->getServiceLocator()
                                                                                                                                        ->get(
                                                                                                                                            'doctrine.entitymanager.orm_default')
                                                                                                                                        ->getRepository(
                                                                                                                                    ...
                                                                                                                                    foreach ($mc as $er) {
                                                                                                                                        ...
                                                                                                                                        $er['name'] = '!' .
                                                                                                                                         $er['name'];
                                                                                                                                $er['created_on'] = Utility::formatDateDiff(
                                                                                                                                        $er['create_time']);
                                                                                                                                $event_creator = $eventRep->getUser(
                                                                                                                                        $er['user_id'], 
                                                                                                                                        'row');
                                                                                                                                $er['event_creator_name'] = '@' .
                                                                                                                    ...
                                                                                                                    $qb->select(
                                                                                                                            'ef');
                                                                                                                    $qb->from(
                                                                                                                            'Application\Entity\EventFriend', 
                                                                                                                            'ef');
                                                                                                                    $qb->andWhere(
                                                                                                                            'ef.event_id IN (:e)')->andWhere(
                                                                                                                            'ef.friend_id =:f');
                                                                                                                    ...
                                                                                                                    foreach ($search_result as $k => &$srRow) {
                                                                                                                        if (isset(
                                                                                                                                $chkEventFriend[$event_ids[$k]])) {
                                                                                                                            $srRow['event_request_sent'] = $chkEventFriend[$event_ids[$k]];
                                                                                                                        }
                                                                                                                    }
                                                                                                                    
                                                                                                                    $comments = $eventRep->createDiscoverCache(
                                                                                                                            $tag);
						...
						$search_result = array();
                                                                                                                    if ((MemreasConstants::REDIS_SERVER_USE) &&
                                                                                                                        ...
                                                                                                                        // PHP_EOL
                                                                                                                        // );
                                                                                                                        $tags_public = $this->redis->findSet(
                                                                                                                                '#hashtag', 
                                                                                                                                $search);
                                                                                                                        $tags_uid = $this->redis->findSet(
                                                                                                                                '#hashtag_' .
                                                                                                                                         $user_id, 
                                                                                                                                        $search);
                                                                                                                        $tags_unique = array_unique(
                                                                                                                                array_merge(
                                                                                                                                        $tags_public, 
                                                                                                                                        $tags_uid));
                                                                                                                        // error_log
                                                                                                                        ...
                                                                                                                        // PHP_EOL
                                                                                                                        // );
                                                                                                                        $hashtag_public_eid_hash = $this->redis->cache->hmget(
                                                                                                                        ...
                                                                                                                        // PHP_EOL
                                                                                                                        // );
                                                                                                                        $hashtag_friends_hash = $this->redis->cache->hmget(
                                                                                                                                '#hashtag_friends_hash_' .
                                                                                                                                         $user_id, 
                                                                                                                                        $tags_unique);
                                                                                                                        // error_log
                                                                                                                        // (
                                                                                                                        ...
                                                                                                                        $eventRep = $this->getServiceLocator()
                                                                                                                            ...
                                                                                                                            ->getRepository(
                                                                                                                                'Application\Entity\Event');
                                                                                                                        $mc = $eventRep->createDiscoverCache(
                                                                                                                                $search);
                                                                                                                        // $usernames
                                                                                                                        // =
                                                                                                                        // $this->redis->findSet(
                                                                                                                        ...
                                                                                                                        // PHP_EOL
                                                                                                                        // );
                                                                                                                        $hashtag_cache = $eventRep->createDiscoverCache(
                                                                                                                                $tag);
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    foreach ($hashtag_cache as $tag => $cache_entry) {
                                                                                                                        ...
                                                                                                                        if (stripos(
                                                                                                                            ...
                                                                                                                            // $limit))
                                                                                                                            // {
                                                                                                                            $cache_entry['updated_on'] = Utility::formatDateDiff(
                                                                                                                                    $cache_entry['update_time']);
                                                                                                                            $cache_entry['update_time'] = Utility::toDateTime(
                                                                                                                                    $cache_entry['update_time']);
                                                                                                            ...
                                                                                                            if ($actionname ==
                                                                                                                ...
                                                                                                                foreach ($mc as $eid => $er) {
                                                                                                                    ...
                                                                                                                    $er['name'] = '!' .
                                                                                                                     $er['name'];
                                                                                                            $er['comment_count'] = $eventRep->getCommentCount(
                                                                                                                    $eid);
                                                                                                            $er['like_count'] = $eventRep->getLikeCount(
                                                                                                                    $eid);
                                                                                                            $er['friends'] = $eventRep->getEventFriends(
                                                                                                                    $eid);
                                                                                                            $search_result[] = $er;
                                                                                                        }
                                                                                            ...
                                                                                            if ($actionname ==
                                                                                                 ...
                                                                                                 * N/a
                                                                                                 */
                                                                                                $signedurl = new MemreasSignedURL(
                                                                                                        $message_data, 
                                                                                                        $memreas_tables, 
                                                                                                        $this->getServiceLocator());
                                                                                                    ...
                                                                                                    if ($actionname ==
                                                                                                        ...
                                                                                                        if ($actionname ==
                                                                                                            ...
                                                                                                            if ($actionname ==
                                                                                                                 ...
                                                                                                                 * later
                                                                                                                 */
                                                                                                                $logout = new ClearAllNotification(
                                                                                                                        $message_data, 
                                                                                                                        $memreas_tables, 
                                                                                                                        $this->getServiceLocator());
                                                                                                                $result = $logout->exec();
                                                                                                                $data = simplexml_load_string(
                                                                                                                        $_POST['xml']);
                                                                                                                $uid = trim(
                                                                                                                        $data->clearallnotification->user_id);
                                                                                                                /*
                                                                                                                 * Cache
                                                                                                                 * approach
                                                                                                                 * -
                                                                                                                ...
                                                                                                                if ($actionname ==
                                                                                                                    ...
                                                                                                                    if ($actionname ==
                                                                                                                        ...
                                                                                                                        if ($actionname ==
                                                                                                                                 "registercanonicaldevice") {
                                                                                                                            $register_canonical_device = new RegisterCanonicalDevice(
                                                                                                                                    $message_data, 
                                                                                                                                    $memreas_tables, 
                                                                                                                                    $this->getServiceLocator());
                                                                                                                            ...
                                                                                                                            if ($actionname ==
                                                                                                                                ...
                                                                                                                                $data = simplexml_load_string(
                                                                                                                                        $_POST['xml']);
                                                                                                                                if (! empty(
                                                                                                                                        $data->listcomments->event_id) &&
                                                                                                                                         ! empty(
                                                                                                                                                $data->listcomments->media_id)) {
                                                                                                                                    $cache_id = trim(
                                                                                                                                            $data->listcomments->event_id) .
                                                                                                                                     "_" .
                                                                                                                                     trim(
                                                                                                                        ...
                                                                                                                        if ($actionname ==
                                                                                                                            ...
                                                                                                                            if ($actionname ==
                                                                                                                                ...
                                                                                                                                $data = simplexml_load_string(
                                                                                                                                        $_POST['xml']);
                                                                                                                                $cache_id = trim(
                                                                                                                                        $data->geteventlocation->event_id);
                                                                                                                                $result = $this->redis->getCache(
                                                                                                                                        $actionname .
                                                                                                                                                 '_' .
                                                                                                                                                 $cache_id);
                                                                                                                                ...
                                                                                                                                if (! $result ||
                                                                                                                                         empty(
                                                                                                                                                $result)) {
                                                                                                                                    $GetEventLocation = new GetEventLocation(
                                                                                                                                            $message_data, 
                                                                                                                                            $memreas_tables, 
                                                                                                                                            $this->getServiceLocator());
                                                                                                                                ...
                                                                                                                                if ($actionname ==
                                                                                                                                    ...
                                                                                                                                    if (! $result ||
                                                                                                                                             empty(
                                                                                                                                                    $result)) {
                                                                                                                                        $GetEventLocation = new GetEventCount(
                                                                                                                                                $message_data, 
                                                                                                                                                $memreas_tables, 
                                                                                                                                                $this->getServiceLocator());
                                                                                                                                        $result = $GetEventLocation->exec();
                                                                                                                                    ...
                                                                                                                                    if ($actionname ==
                                                                                                                                        ...
                                                                                                                                        if ($actionname ==
                                                                                                                                             ...
                                                                                                                                             * needed
                                                                                                                                             */
                                                                                                                                            $SaveUserDetails = new SaveUserDetails(
                                                                                                                                                    $message_data, 
                                                                                                                                                    $memreas_tables, 
                                                                                                                                                    $this->getServiceLocator());
                                                                                                                                            ...
                                                                                                                                            if ($actionname ==
                                                                                                                                                ...
                                                                                                                                                if ($actionname ==
                                                                                                                                                    ...
                                                                                                                                                    $data = simplexml_load_string(
                                                                                                                                                            $_POST['xml']);
                                                                                                                                                    $group_id = trim(
                                                                                                                                                            $data->getgroupfriends->group_id);
                                                                                                                                                    $network = trim(
                                                                                                                                                            $data->getgroupfriends->network);
                                                                                                                                                    $cache_id = $group_id;
                                                                                                                                                    ...
                                                                                                                                                    if (! $result ||
                                                                                                                                                             empty(
                                                                                                                                                                    $result)) {
                                                                                                                                                        $GetGroupFriends = new GetGroupFriends(
                                                                                                                                                                $message_data, 
                                                                                                                                                                $memreas_tables, 
                                                                                                                                                                $this->getServiceLocator());
                                                                                                                                                    ...
                                                                                                                                                    if ($actionname ==
                                                                                                                                                         ...
                                                                                                                                                         * needed
                                                                                                                                                         */
                                                                                                                                                        $AddFriendToGroup = new AddFriendToGroup(
                                                                                                                                                                $message_data, 
                                                                                                                                                                $memreas_tables, 
                                                                                                                                                                $this->getServiceLocator());
                                                                                                                                                        ...
                                                                                                                                                        if ($actionname ==
                                                                                                                                                                 "removefriendgroup") {
                                                                                                                                                            $RemoveFriendGroup = new RemoveFriendGroup(
                                                                                                                                                                    $message_data, 
                                                                                                                                                                    $memreas_tables, 
                                                                                                                                                                    $this->getServiceLocator());
                                                                                                                                                            ...
                                                                                                                                                            if ($actionname ==
                                                                                                                                                                ...
                                                                                                                                                                if (! $result ||
                                                                                                                                                                         empty(
                                                                                                                                                                                $result)) {
                                                                                                                                                                    $GetEventPeople = new GetEventPeople(
                                                                                                                                                                            $message_data, 
                                                                                                                                                                            $memreas_tables, 
                                                                                                                                                                            $this->getServiceLocator());
                                                                                                                                                                ...
                                                                                                                                                                if ($actionname ==
                                                                                                                                                                    ...
                                                                                                                                                                    $AddExistMediaToEvent = new AddExistMediaToEvent(
                                                                                                                                                                            $message_data, 
                                                                                                                                                                            $memreas_tables, 
                                                                                                                                                                            $this->getServiceLocator());
                                                                                                                                                                    ...
                                                                                                                                                                    if ($actionname ==
                                                                                                                                                                        ...
                                                                                                                                                                        if ($actionname ==
                                                                                                                                                                             ...
                                                                                                                                                                             * caching...
                                                                                                                                                                             */
                                                                                                                                                                            $CheckExistMedia = new CheckExistMedia(
                                                                                                                                                                                    $message_data, 
                                                                                                                                                                                    $memreas_tables, 
                                                                                                                                                                                    $this->getServiceLocator());
                                                                                                                                                                            ...
                                                                                                                                                                            if ($actionname ==
                                                                                                                                                                                ...
                                                                                                                                                                                $data = simplexml_load_string(
                                                                                                                                                                                        $_POST['xml']);
                                                                                                                                                                                $cache_id = trim(
                                                                                                                                                                                        $data->listmemreasfriends->user_id);
                                                                                                                                                                                $result = $this->redis->getCache(
                                                                                                                                                                                        $actionname .
                                                                                                                                                                                                 '_' .
                                                                                                                                                                                                 $cache_id);
                                                                                                                                                                                ...
                                                                                                                                                                                if (! $result ||
                                                                                                                                                                                         empty(
                                                                                                                                                                                                $result)) {
                                                                                                                                                                                    $ListMemreasFriends = new ListMemreasFriends(
                                                                                                                                                                                            $message_data, 
                                                                                                                                                                                            $memreas_tables, 
                                                                                                                                                                                            $this->getServiceLocator());
                                                                                                                                                                                ...
                                                                                                                                                                                if ($actionname ==
                                                                                                                                                                                     ...
                                                                                                                                                                                     * query
                                                                                                                                                                                     */
                                                                                                                                                                                    $GetSocialCredentials = new GetSocialCredentials(
                                                                                                                                                                                            $message_data, 
                                                                                                                                                                                            $memreas_tables, 
                                                                                                                                                                                            $this->getServiceLocator());
                                                                                                                                                                                        ...
                                                                                                                                                                                        if ($actionname ==
                                                                                                                                                                                            ...
                                                                                                                                                                                            if ($actionname ==
                                                                                                                                                                                                ...
                                                                                                                                                                                                if (! $result ||
                                                                                                                                                                                                         empty(
                                                                                                                                                                                                                $result)) {
                                                                                                                                                                                                    $GetEventDetails = new GetEventDetails(
                                                                                                                                                                                                            $message_data, 
                                                                                                                                                                                                            $memreas_tables, 
                                                                                                                                                                                                            $this->getServiceLocator());
                                                                                                                                                                                                ...
                                                                                                                                                                                                if ($actionname ==
                                                                                                                                                                                                         "removeeventmedia") {
                                                                                                                                                                                                    $RemoveEventMedia = new RemoveEventMedia(
                                                                                                                                                                                                            $message_data, 
                                                                                                                                                                                                            $memreas_tables, 
                                                                                                                                                                                                            $this->getServiceLocator());
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if ($actionname ==
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         * needed
                                                                                                                                                                                                         */
                                                                                                                                                                                                        $RemoveEventFriend = new RemoveEventFriend(
                                                                                                                                                                                                                $message_data, 
                                                                                                                                                                                                                $memreas_tables, 
                                                                                                                                                                                                                $this->getServiceLocator());
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if ($actionname ==
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            $RemoveFriends = new RemoveFriends(
                                                                                                                                                                                                                    $message_data, 
                                                                                                                                                                                                                    $memreas_tables, 
                                                                                                                                                                                                                    $this->getServiceLocator());
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if ($actionname ==
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if ($actionname ==
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if ($actionname ==
                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                         * now
                                                                                                                                                                                                                         */
                                                                                                                                                                                                                        $GetPlansStatic = new GetPlansStatic(
                                                                                                                                                                                                                                $message_data, 
                                                                                                                                                                                                                                $memreas_tables, 
                                                                                                                                                                                                                                $this->getServiceLocator());
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    if ($actionname ==
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if ($actionname ==
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            if ($actionname ==
                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                 * now
                                                                                                                                                                                                                                                 */
                                                                                                                                                                                                                                                $GetAccountDetail = new GetAccountDetail(
                                                                                                                                                                                                                                                        $message_data, 
                                                                                                                                                                                                                                                        $memreas_tables, 
                                                                                                                                                                                                                                                        $this->getServiceLocator());
...
Mlog::addone(__CLASS__ . __METHOD__ . 'requiresSecureAction($actionname)', 
$actionname);
return true;
}
...
if (! empty($_SESSION['ipAddress']) &&
 ($currentIPAddress != $_SESSION['ipAddress'])) {
 ...
 */
$ipAddress = $this->getServiceLocator()
->get('Request')

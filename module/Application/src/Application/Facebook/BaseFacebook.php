...
abstract class BaseFacebook {
	 ...
	 * be retained as part of the query string.
	 * This amounts to
	 ...
	 * because the access token is no longer valid.
	 * If that is
	 * the case, then we destroy the session.
	 *
	 * @param $result array
	 *        	A record storing the error message returned

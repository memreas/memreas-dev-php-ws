...
class Comment {
	/**
	 *
	 * @var string @ORM\Column(name="comment_id", type="string", length=255, nullable=false)
	 *      @ORM\Id
	 */
	private $comment_id;
	...
	/**
	 *
	 * @var boolean @ORM\Column(name="`like`", type="boolean", nullable=false)
	 */
	private $like = 0;
	
	/**
	 *
	 * @var string @ORM\Column(name="text", type="text", nullable=false)
	 */
	private $text = 0;
	...
	/**
	 *
	 * @var string @ORM\Column(name="audio_id", type="string", length=255, nullable=false)
	 */
	private $audio_id = 0;

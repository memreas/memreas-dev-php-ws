...
class Friend {
	...
	/**
	 *
	 * @var string @ORM\Column(name="network", type="string", length=255, nullable=false)
	 */
	private $network;
	
	/**
	 *
	 * @var string @ORM\Column(name="social_username", type="string", length=255, nullable=false)
	 */
	private $social_username;
	
	/**
	 *
	 * @var string @ORM\Column(name="url_image", type="string", length=255, nullable=false)
	 */
	private $url_image;

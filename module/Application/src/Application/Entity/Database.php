...
class Database {
	...
	/**
	 *
	 * @var string @ORM\Column(name="endpoint", type="string", length=255, nullable=false)
	 */
	private $endpoint;
	
	/**
	 *
	 * @var string @ORM\Column(name="region", type="string", length=50, nullable=false)
	 */
	private $region;
	...
	/**
	 *
	 * @var float @ORM\Column(name="utilization_percent", type="decimal", precision=10, scale=2, nullable=false)
	 */

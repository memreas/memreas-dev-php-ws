 ...
 * @copyright 2013
 */
namespace Application\TwitterOAuth;

use Application\TwitterOAuth\Exception\TwitterException;
...
class TwitterOAuth {
	 ...
	 *
	 * @param
	 *        	s array $config Configuration array with OAuth access data
	 */
	 ...
	 *        	If true then parameters will be outputted
	...
	protected function getOauthString() {
		$oauth = array_merge ( $this->getOauthParameters (), array (
				'oauth_signature' => $this->calculateSignature () 
		) );
	 ...
	 *
	 * @param string $type
	 *        	Depends of response format (array|object)
	 * @param mixed $ex
	 *        	Exceptions

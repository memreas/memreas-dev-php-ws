...
class CountListallmedia {
	...
	public function exec() {
		...
		/*
		 * $q = "select media.metadata ,media.media_id from Application\Entity\Media inner join Application\Entity\EventMedia as em on media.media_id=em.media_id inner join Application\Entity\Event as e on em.event_id=e.event_id where e.event_id='$event_id' ORDER BY `media`.`media_id` DESC";
		 */

		...
		if (! empty ( $userid )) {
			...
			if (count ( $result ) > 0) {
				...
				foreach ( $result as $row ) {
					...
					// User data needed for all scenarios...
					if (! empty ( $from_user_id )) {
						...
						$xml_output .= "<profile_username>$from_user->username</profile_username>";
						...
						// missing user_id
						$xml_output .= "<profile_username></profile_username>";
						$xml_output .= "<profile_pic><![CDATA[]]></profile_pic>";
						$xml_output .= "<profile_pic_79x80><![CDATA[]]></profile_pic_79x80>";
						$xml_output .= "<profile_pic_448x306><![CDATA[]]></profile_pic_448x306>";
						$xml_output .= "<profile_pic_98x78><![CDATA[]]></profile_pic_98x78>";
					}

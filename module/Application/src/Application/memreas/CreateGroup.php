	...
	public function exec() {
		...
		if (! isset ( $group_name ) || empty ( $group_name )) {
			...
			if (! empty ( $result )) {
				...
				/*
				 * $query_group = "INSERT INTO Application\Entity\Group (group_id,`user_id` , `group_name` , `create_date` , `update_date` ) VALUES ('$group_id','$user_id','$group_name','$time','$time')";
				 */

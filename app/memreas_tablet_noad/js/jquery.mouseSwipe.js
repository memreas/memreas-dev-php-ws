...
var panel = plugin.children("div"); // panels inside slider.

var vw = parseInt(plugin.parents('div').css('width'),10)+90;  //viewport width.
var vh = parseInt(plugin.parents('div').css('height'),10); //viewport height.
var _velocity = 0, bouncing = 0, _mouseDownLT, _mouseDownXY, _lastMouseDownXY, panelnum=0;
...
if (o.HORIZ==true) {
  var sliderW = parseInt(panel.css('width'),10) *(parseInt(panel.length)+2);
